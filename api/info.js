...
const info = {
  ...
  // 获取商品码
  getProductBuyCodeUrl: data => request.http('info/goods.do?method=getProductBuyCodeUrl', data),
  // 获取商品详情页参数
  getUrlParamScene: data => request.http('info/goods.do?method=getUrlParamScene', data),
  // 获取商品详情
  getProductDetails: data => request.http('info/goods.do?method=getProductDetails', data),
  // 获取拼团信息
  groupIncrease: data => request.http('info/goods.do?method=groupIncrease', data),
  // 获取拼团列表
  getGroupList: data => request.http('info/goods.do?method=getGroupList', data),
  // 获取砍价列表
  getHackList: data => request.http('info/goods.do?method=getHackList', data),
  // 发起拼团
  groupAdd: data => request.http('info/goods.do?method=groupAdd ', data),
  // 参团验证
  getGroupInfo: data => request.http('info/goods.do?method=getGroupInfo ', data),
  // 参与拼团
  groupEnd : data => request.http('info/goods.do?method=groupEnd ', data),
  // 获取砍价信息
  generateHackBill: data => request.http('info/goods.do?method=generateHackBill', data),
  // 发起砍价
  hackAdd : data => request.http('info/goods.do?method=hackAdd ', data),
  // 参与砍价
  hackIncrease : data => request.http('info/goods.do?method=hackIncrease ', data),
  // 设置常购
