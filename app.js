...
App({
  ...
  globalData: {
    ...
    // // 美廉美优选 牙克石美廉美超市
    // apptitle: '美廉美优选',
    // // baseUrl: 'https://www.mlmcs2021.com:58443/eshop/', // 2.5.0版以前路径
    // baseUrl: 'https://mmyx.91jyrj.com:58443/eshop/', // 2.5.0版（包含2.5.0版）以后路径
  ...
  toBannerDetail(banner) {
    ...
    switch (linktype) {
      case 1:
        ...
        wx.navigateTo({
          url:
            '/shopping/pages/goodsList/goodsList?panicBuy=' +
            'panicBuy' +
            '&title=' +
            '限时秒杀' +
            '&promotemode=101',
      ...
      case 2:
        ...
        wx.navigateTo({
          url:
            '/shopping/pages/goodsList/goodsList?Classcode=' +
            banner.linkcode +
            '&title=' +
            '商品列表',
        });
      ...
      case 3:
        ...
        wx.navigateTo({
          url:
            '/shopping/pages/goodsList/goodsList?Cateid=' +
            banner.linkcode +
            '&title=' +
            '商品列表',
        });
      ...
      case 4:
        ...
        wx.navigateTo({
          url:
            '/message/pages/detail/detail?id=' +
            banner.linkcode +
            '&type=notice',
        });
        break;
    ...
    return new Promise((resolve, reject) => {
      wx.login({
        success: (res) => {
          ...
          reject({ msg: '微信登录失败！' + res.errMsg, data: '' })
        },
      });
    })
  },
      ...
      API.system
        ...
        .then((result) => {
          ...
          if (res.flag === 1) {
            ...
            resolve({ code: 200, data: openid, msg: '' })
          } else {
            // toast(res.message);
            reject({ code: 0, msg: res.message })
          }
        })
        .catch((error) => {
          toast(error.error);
